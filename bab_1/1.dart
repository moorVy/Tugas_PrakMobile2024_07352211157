...
void main() async {
  ...
  var admin = AdminUser(name: "Ali Muhammad", age: 21);
  var customer = CustomerUser(name: "Bilqish Naura", age: 25);

  // Menambah produk dengan AdminUser
  var product1 = Product(productName: "Laptop Gaming", price: 25000000, inStock: true);
  var product2 =
      Product(productName: "Smartphone", price: 10000000, inStock: false);
  var product3 =
      Product(productName: "Airpods", price: 3000000, inStock: true);
